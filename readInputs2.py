...
def readAllFiles(signal_files):
    problemFiles = []
    f = h5py.File(config.write_database, 'a')
    dset1 = f.create_dataset('signals', (0, config.max_seq_len), maxshape=(None, config.max_seq_len), dtype='f')
    dset2 = f.create_dataset('labels', (0, config.max_base_len), maxshape=(None, config.max_base_len), dtype='i8')
    dset3 = f.create_dataset('signal_lengths', (0,), maxshape=(None,), dtype='i8')
    dset4 = f.create_dataset('base_lengths', (0,), maxshape=(None,), dtype='i8')
